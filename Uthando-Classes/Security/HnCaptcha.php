...
class Security_HnCaptcha
{
    ...
    //
        ...
        public function display_form_part($which='all')
        {
            ...
            if($which==='input')
            {
				$ret .= '<input class="inputbox" type="text" name="hncaptcha_private_key" value="" maxlength="'.$this->chars.'" size="'.$this->chars.'" />'."\n";
            }
            ...
            if($which==='refresh_button' || $which==='refreshbutton')
            {
				...
				$ret .= '<input class="button" type="submit" name="hncaptcha_refresh" value="'.$this->refreshbuttontext.'" />'."\n";
            }
