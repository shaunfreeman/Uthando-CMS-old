...
$this->registry->page_title = 'ushop/browse/'.$this->registry->params[0];
...
if ($this->ushop->global['offline']):
	...
	$content = '<center><img src="/images/ushop/closed-sign.png" /></cente>';
	...
	if ($num > $display):
		$paginate = new HTML_Paginate('products', $start, '/ushop/browse/' . $this->registry->params[0] . '/pstart-{start}', $num, $display);
