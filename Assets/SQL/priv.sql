#admin
GRANT USAGE ON *.* TO 'uthando_admin'@'localhost' IDENTIFIED BY PASSWORD '*2470C0C06DEE42FD1618BB99005ADCA2EC9D1E19';
...
GRANT SELECT, INSERT, UPDATE, DELETE ON `UthandoCMS_sessions`.`shaunfre` TO 'uthando_admin'@'localhost';
GRANT SELECT, INSERT, UPDATE, DELETE ON `uthando_ushop`.* TO 'uthando_admin'@'localhost';

#user
GRANT USAGE ON *.* TO 'uthando_user'@'localhost' IDENTIFIED BY PASSWORD '*2470C0C06DEE42FD1618BB99005ADCA2EC9D1E19';
...
GRANT SELECT, INSERT, UPDATE, DELETE ON `UthandoCMS_sessions`.`shaunfre` TO 'uthando_user'@'localhost';
...
#guest
GRANT USAGE ON *.* TO 'uthando_guest'@'localhost' IDENTIFIED BY PASSWORD '*2470C0C06DEE42FD1618BB99005ADCA2EC9D1E19';
...
GRANT SELECT, INSERT, UPDATE, DELETE ON `UthandoCMS_sessions`.`shaunfre` TO 'uthando_guest'@'localhost';
