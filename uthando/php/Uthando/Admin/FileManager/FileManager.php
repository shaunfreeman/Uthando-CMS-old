...
class FileManager {
	...
	protected function onCreate(){
		if(!$this->options['create'] || empty($this->post['directory']) || empty($this->post['file'])) return;
	...
	protected function onMove(){
		if(!$this->options['move'] || empty($this->post['directory']) || empty($this->post['file'])) return;
