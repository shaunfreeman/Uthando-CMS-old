 ...
 * Autoloader helpers
 */
function _Uthando_Autloader_SetUp() {
    require_once 'Zend/Loader/Autoloader.php';
    $loader = Zend_Loader_Autoloader::getInstance();
    $loader->registerNamespace('Uthando_');
}

function _Uthando_Autloader_TearDown() {
...
PHP_CodeCoverage_Filter::getInstance()
        ->addDirectoryToBlacklist("$root/tests");
